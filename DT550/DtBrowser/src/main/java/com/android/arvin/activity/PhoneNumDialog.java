...
/**
 * Created by yanglei on 2017/9/22.
 */
...
public class PhoneNumDialog  extends Dialog {
    ...
    public PhoneNumDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public PhoneNumDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            final PhoneNumDialog dialog = new PhoneNumDialog(context, R.style.Dialog);
