...
public class EncryptTool {
    ...
    public String objToBase64Str(Object obj) {
        ...
        return new String(Base64.encodeToString(bOut.toByteArray(), bOut.size()));
    }

    public Object Base64StrToObj(String str) {
        ByteArrayInputStream bIn = null;
        ObjectInputStream objIn = null;
        try {
            byte[] objBytes = Base64.decode(str, Base64.DEFAULT);
            bIn = new ByteArrayInputStream(objBytes);
    ...
    public String loadFileMD5(String destFile) {
        String md5 = null;
